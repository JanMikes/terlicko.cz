...
export interface ApiAktualityAktuality extends Struct.CollectionTypeSchema {
...
export interface ApiFormularFormular extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Email_predmet: Schema.Attribute.String & Schema.Attribute.Required;
    Email_prijemce: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Rychle_odkazy: Schema.Attribute.Component<
      'elementy.homepage-rychly-odkaz',
      true
    >;
    Slider: Schema.Attribute.Component<'elementy.slide', true>;
    Tipy_a_aktivity: Schema.Attribute.Component<
      'elementy.homepage-karta',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Vsechny_tipy_a_aktivity_odkaz: Schema.Attribute.Component<
      'elementy.odkaz',
      false
    >;
  };
...
export interface ApiLideLide extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::lide.lide'> &
      Schema.Attribute.Private;
    Pohlavi: Schema.Attribute.Enumeration<['zena', 'muz']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTagyTagy extends Struct.CollectionTypeSchema {
