 ...
 * @phpstan-type HomepageRychlyOdkazDataArray array{
 *     Nadpis: null|string,
 *     Text: null|string,
 ...
 * }
 */
readonly final class HomepageRychlyOdkazData
{
    /** @use CanCreateManyFromStrapiResponse<HomepageRychlyOdkazDataArray> */
    ...
    /**
     * @param HomepageRychlyOdkazDataArray $data
     */
